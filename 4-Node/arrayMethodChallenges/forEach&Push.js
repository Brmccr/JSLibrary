...
// use array and .push loop over all presidents and then push the last name and year they were born to a new array
...
let president = presidents.forEach(function(e){
    console.log(e);

    var NewArray = ([]).push(`${presidents.first}, ${presidents.last}`);
    console.log(NewArray);
    // let NewArray = [];
    // NewArray.push(`${presidents.first} ${presidents.last}`);
    // console.log(NewArray);
});
